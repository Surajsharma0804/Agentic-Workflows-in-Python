...
export default function Register() {
  ...
  const { register, loginWithGoogle, loginWithApple, loginWithGithub } = useAuth()
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 bg-gray-950 border border-gray-800 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                  placeholder="••••••••"
                />
                <button
                  type="button"
                    ...
                    {[0, 1, 2, 3].map((i) => (
                      <div
                        ...
                        className={`h-1 flex-1 rounded-full transition-all ${
                          i < strength ? strengthColors[strength - 1] : 'bg-gray-800'
                        }`}
                      />
                    ))}
                  </div>
            ...
            <label className="flex items-start cursor-pointer">
              <input
                ...
                className="w-4 h-4 mt-0.5 rounded bg-gray-950 border-gray-800 text-blue-500 focus:ring-2 focus:ring-blue-500/20"
              />
          ...
          <div className="grid grid-cols-3 gap-3">
            <motion.button
              ...
              disabled={isLoading}
              className="flex items-center justify-center p-3 bg-gray-800/50 border border-gray-700 rounded-lg hover:bg-gray-800 transition-all"
            >
